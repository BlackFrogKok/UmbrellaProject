...
public class Station {
    ...
    public void checkQrData(String result, OnCompleteDataListener<String> listener) {
        try {
    ...
    public void checkCode(String result, OnCompleteDataListener<String> listener){
        String[] subStr;
        subStr = result.split("-");
        if (subStr.length == 2){
            dataBase.collection("stations").document(subStr[1])
